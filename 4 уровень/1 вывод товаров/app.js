...
let requestAllButton = document.querySelectorAll('button');
let requestDiv = document.querySelector('div');
requestAllButton.forEach(function (event) {
...
function showCategory(category) {
    ...
    let marcupFilterTovar = '';
    product.forEach(function (product) {
        marcupFilterTovar += getProductMarkup(product);
    });
    requestDiv.insertAdjacentHTML('afterbegin', marcupFilterTovar);
}
